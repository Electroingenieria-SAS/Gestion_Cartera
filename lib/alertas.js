...
// Devuelve el set de NITs que YA fueron gestionados hoy (cualquier gestión cuenta).
// Estos clientes salen de las listas de trabajo hasta la próxima carga (mañana).
